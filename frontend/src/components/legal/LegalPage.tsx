...
const legalCopy = {
  ...
  ar: {
    ...
    terms: { title: 'شروط الاستخدام', intro: 'باستخدام موقع Estate فإنك توافق على الشروط التالية.', sections: [['معلومات الموقع', 'المحتوى والأسعار لأغراض إرشادية، ويؤكد المستشار الشروط الحالية قبل اتخاذ القرار.'], ['الطلبات', 'عند إرسال النموذج فإنك تؤكد صحة البيانات وتسمح لنا بالتواصل معك بشأن طلبك.'], ['الملكية الفكرية', 'لا يجوز استخدام نصوص الموقع وتصميمه ومواده تجارياً دون إذن.'], ['المسؤولية', 'تعمل Estate على إبقاء المعلومات محدثة، لكنها لا تضمن خلو الموقع دائماً من الأخطاء التقنية أو الانقطاعات المؤقتة.']] },
  },
} as const;
