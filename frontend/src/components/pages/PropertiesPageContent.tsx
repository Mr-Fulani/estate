    ...
    <div className="min-h-screen bg-slate-50 py-10">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          <aside className="lg:col-span-1"><div className="lg:sticky lg:top-24 lg:z-20 lg:max-h-[calc(100vh-110px)] lg:overflow-y-auto lg:pr-1"><PropertyFilter categories={categories} /></div></aside>
