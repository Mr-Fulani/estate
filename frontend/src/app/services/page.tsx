...
export const metadata = {
  ...
  description: 'Полный комплекс риелторских и юридических услуг: покупка, продажа, аренда, ипотека и инвестиции в недвижимость.',
};
...
const mainServices = [
  ...
  },
  {
    ...
    tagline: 'Одобрение ипотеки на самых выгодных условиях',
    description: 'Подберем оптимальную ипотечную программу со сниженной ставкой от ведущих банков-партнеров даже в сложных ситуациях.',
    features: [
      'Преференции и скидки по ставкам до 1% от банков-партнеров',
      'Подача заявки в несколько банков по одному пакету документов',
      'Работа со сложными случаями и материнским капиталом',
