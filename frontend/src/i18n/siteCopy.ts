...
export const siteCopy: Record<Locale, SiteCopy> = {
  ru: {
    ...
    catalog: {
      ...
      location: 'Город или район', locationPlaceholder: 'Введите город или район…', price: 'Стоимость (₽)', from: 'От', to: 'До', rooms: 'Комнаты', area: 'Площадь (м²)', apply: 'Показать результаты',
    },
    property: {
      ...
      noPhoto: 'Нет фото', related: 'Похожие объекты', photosSoon: 'Фотографии скоро появятся', photo: 'Фото', mainPhoto: 'Главное', enlarge: 'Увеличить фото', previousPhoto: 'Предыдущее фото', nextPhoto: 'Следующее фото', close: 'Закрыть',
  ...
  tr: {
    ...
    news: { eyebrow: 'Haberler ve analizler', title: 'Gayrimenkulü yakından tanıyın', description: 'Piyasa analizleri, hukuki bilgiler ve alıcı, satıcı ve yatırımcılar için pratik öneriler.', metaTitle: 'Gayrimenkul haberleri ve analizleri — {brand}', metaDescription: 'Piyasa analizleri, alım satım önerileri, hukuki rehberler ve {brand} haberleri.', readMore: 'Makaleyi oku', allArticles: 'Tüm haberler', empty: 'Henüz yayın yok', back: 'Tüm yayınlar', by: 'Yazar', previous: 'Önceki', next: 'Sonraki', page: 'Sayfa', fallbackNotice: 'Bu makale şu anda Rusça olarak sunuluyor.', imageAlt: 'Makale kapak görseli', mediaTitle: 'Fotoğraf ve video', photo: 'Fotoğraf', video: 'Video', openImage: 'Görseli aç', previousImage: 'Önceki görsel', nextImage: 'Sonraki görsel', closeMedia: 'Kapat' },
    reviews: { title: 'Müşteri yorumları', description: '{brand} alıcılarının, satıcılarının, kiracıların ve yatırımcıların gerçek deneyimleri.', metaTitle: '{brand} müşteri yorumları', metaDescription: '{brand} ile gayrimenkul alım, satım ve kiralama süreçlerine ait doğrulanmış müşteri yorumları.', leaveTitle: 'Yorum bırakın', leaveDescription: 'Deneyiminizi paylaşın. Yorumunuz kontrolden sonra yayınlanacaktır.', name: 'Adınız', role: 'Hizmet veya rol', email: 'Doğrulama için e-posta', phone: 'Doğrulama için telefon', rating: 'Puan', content: 'Yorumunuz', consent: 'Yorumumun yayınlanmasını ve ilettiğim verilerin işlenmesini kabul ediyorum.', submit: 'Yorumu gönder', submitting: 'Gönderiliyor…', successTitle: 'Teşekkür ederiz!', successDescription: 'Yorumunuzu aldık ve moderasyondan sonra yayınlayacağız.', error: 'Yorum gönderilemedi. Alanları kontrol edip tekrar deneyin.', verified: 'Doğrulanmış işlem', companyResponse: '{brand} yanıtı', empty: 'Henüz yayınlanmış yorum yok.', invitationInvalid: 'Bu kişisel bağlantı geçersiz veya süresi dolmuş.', viewAll: 'Tüm yorumlar', leaveReview: 'Yorum bırakın' },
