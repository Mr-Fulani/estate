...
export const siteCopy: Record<Locale, SiteCopy> = {
  ru: {
    home: {
      ...
      title: 'Найдите идеальную недвижимость с Estate',
      ...
      featuredDescription: 'Лучшие предложения, отобранные экспертами Estate.',
      ...
      testimonials: [
        { name: 'Елена Смирнова', role: 'Покупатель квартиры', content: 'Команда Estate помогла нам спокойно пройти весь путь покупки первой квартиры и тщательно проверила документы.', initial: 'Е' },
      ...
      converter: {
        eyebrow: 'Валютный сервис Estate',
    ...
    property: {
      back: 'Вернуться в каталог', interested: 'Заинтересовал объект?', interestedDescription: 'Оставьте контакты, и наш агент свяжется с вами.', recommended: 'Рекомендуем', actual: 'Актуально', archived: 'В архиве',
    ...
    about: {
      title: 'О компании Estate', intro: 'Мы — команда профессионалов, которая помогает находить подходящую недвижимость и принимать взвешенные инвестиционные решения.',
  ...
  en: {
    home: {
      eyebrow: 'Premium real estate agency', title: 'Find the right property with Estate', description: 'Selected apartments, houses and commercial properties with expert support from the first search to completion.', stats: ['Properties listed', 'Years of experience', 'Clients'],
      ...
      featuredTitle: 'Featured properties', featuredDescription: 'Selected opportunities curated by Estate experts.', viewAll: 'View all', servicesTitle: 'Our services', servicesDescription: 'End-to-end real estate support built around your goals.',
      services: [
      ...
      testimonialsTitle: 'Client stories', testimonialsDescription: 'What clients say after working with our team.', testimonials: [
        { name: 'Elena Smirnova', role: 'Apartment buyer', content: 'Estate guided us through our first purchase calmly and checked every document in detail.', initial: 'E' },
      ...
      converter: {
        eyebrow: 'Estate currency service', title: 'Compare property values in your preferred currency', description: 'Convert your property budget between roubles, US dollars, euros and Turkish lira using the official reference rate.',
  ...
  tr: {
    home: {
      eyebrow: 'Premium gayrimenkul danışmanlığı', title: 'Doğru gayrimenkulü Estate ile bulun', description: 'Daire, villa ve ticari gayrimenkul seçeneklerinde aramadan tapu sürecine kadar uzman desteği.', stats: ['Portföydeki ilan', 'Yıllık deneyim', 'Müşteri'],
      ...
      featuredTitle: 'Öne çıkan ilanlar', featuredDescription: 'Estate uzmanları tarafından seçilen fırsatlar.', viewAll: 'Tümünü gör', servicesTitle: 'Hizmetlerimiz', servicesDescription: 'Hedefinize göre uçtan uca gayrimenkul desteği.', services: [
        ...
        { name: 'Elena Smirnova', role: 'Daire alıcısı', content: 'Estate ilk satın alma sürecimizi sakin ve düzenli yönetti, tüm belgeleri ayrıntılı kontrol etti.', initial: 'E' },
      ...
      converter: {
        eyebrow: 'Estate döviz servisi', title: 'Gayrimenkul değerini tercih ettiğiniz para biriminde karşılaştırın', description: 'Gayrimenkul bütçenizi resmî referans kuruyla ruble, ABD doları, euro ve Türk lirası arasında hesaplayın.',
    ...
    news: { eyebrow: 'Haberler ve analizler', title: 'Gayrimenkulü yakından tanıyın', description: 'Piyasa analizleri, hukuki bilgiler ve alıcı, satıcı ve yatırımcılar için pratik öneriler.', metaTitle: 'Gayrimenkul haberleri ve analizleri — Estate', metaDescription: 'Piyasa analizleri, alım satım önerileri, hukuki rehberler ve Estate haberleri.', readMore: 'Makaleyi oku', allArticles: 'Tüm haberler', empty: 'Henüz yayın yok', back: 'Tüm yayınlar', by: 'Yazar', previous: 'Önceki', next: 'Sonraki', page: 'Sayfa', fallbackNotice: 'Bu makale şu anda Rusça olarak sunuluyor.', imageAlt: 'Makale kapak görseli', mediaTitle: 'Fotoğraf ve video', photo: 'Fotoğraf', video: 'Video', openImage: 'Görseli aç', previousImage: 'Önceki görsel', nextImage: 'Sonraki görsel', closeMedia: 'Kapat' },
    reviews: { title: 'Müşteri yorumları', description: 'Estate alıcılarının, satıcılarının, kiracıların ve yatırımcıların gerçek deneyimleri.', metaTitle: 'Estate müşteri yorumları', metaDescription: 'Estate ile gayrimenkul alım, satım ve kiralama süreçlerine ait doğrulanmış müşteri yorumları.', leaveTitle: 'Yorum bırakın', leaveDescription: 'Deneyiminizi paylaşın. Yorumunuz kontrolden sonra yayınlanacaktır.', name: 'Adınız', role: 'Hizmet veya rol', email: 'Doğrulama için e-posta', phone: 'Doğrulama için telefon', rating: 'Puan', content: 'Yorumunuz', consent: 'Yorumumun yayınlanmasını ve ilettiğim verilerin işlenmesini kabul ediyorum.', submit: 'Yorumu gönder', submitting: 'Gönderiliyor…', successTitle: 'Teşekkür ederiz!', successDescription: 'Yorumunuzu aldık ve moderasyondan sonra yayınlayacağız.', error: 'Yorum gönderilemedi. Alanları kontrol edip tekrar deneyin.', verified: 'Doğrulanmış işlem', companyResponse: 'Estate yanıtı', empty: 'Henüz yayınlanmış yorum yok.', invitationInvalid: 'Bu kişisel bağlantı geçersiz veya süresi dolmuş.', viewAll: 'Tüm yorumlar', leaveReview: 'Yorum bırakın' },
