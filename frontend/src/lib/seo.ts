...
const staticSeoCopy: Record<StaticSeoPage, Record<Locale, { title: string; description: string }>> = {
  properties: {
    ...
    ar: { title: 'عقارات إسطنبول — دليل Estate', description: 'شقق وفلل وعقارات تجارية في إسطنبول مع الفحص القانوني والدعم الكامل لإتمام الصفقة.' },
  },
  services: {
    ...
    ar: { title: 'الخدمات العقارية في تركيا — Estate', description: 'البحث عن العقارات وشراؤها وبيعها واستئجارها في تركيا مع الفحص القانوني ودعم الصفقة.' },
  },
  about: {
    ...
    ar: { title: 'عن Estate', description: 'تساعد Estate العملاء على شراء العقارات وبيعها واستئجارها في إسطنبول بدعم واضح ومتكامل.' },
  },
  contact: {
    ...
    ar: { title: 'تواصل مع Estate — بيليك دوزو، إسطنبول', description: 'تواصل مع Estate بشأن شراء العقارات أو بيعها أو استئجارها في إسطنبول.' },
  },
  privacy: {
    ...
    ar: { title: 'سياسة الخصوصية — Estate', description: 'كيفية جمع Estate للبيانات الشخصية لزوار الموقع والعملاء واستخدامها وحمايتها.' },
  },
  terms: {
    ...
    ar: { title: 'شروط الاستخدام — Estate', description: 'شروط استخدام موقع Estate ومعلومات العقارات المنشورة فيه.' },
  },
};
