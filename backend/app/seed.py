        ...
        article = NewsArticle(
            ...
            translations=[
                NewsTranslation(
                    ...
                    meta_title="Как выбрать недвижимость в 2026 году — Rahat Home",
                    meta_description="Практический гид Rahat Home по выбору объекта недвижимости.",
                ),
                NewsTranslation(
                    locale="en",
                    ...
                    meta_title="How to choose property in 2026 — Rahat Home",
                    meta_description="Rahat Home's practical guide to choosing the right property.",
                ),
                NewsTranslation(
                    locale="tr",
                    ...
                    meta_title="2026'da gayrimenkul seçimi — Rahat Home",
                    meta_description="Doğru gayrimenkulü seçmek için Rahat Home'in pratik rehberi.",
                ),
                NewsTranslation(
                    locale="ar",
                    ...
                    meta_title="كيفية اختيار عقار في 2026 — Rahat Home",
                    meta_description="دليل Rahat Home العملي لاختيار العقار المناسب.",
                ),
            ],
        )
        db.add(article)
