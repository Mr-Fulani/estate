...
class SiteSetting(Base):
    ...
    email: Mapped[str] = mapped_column(String(100), default="support@rahathome.com")
    ...
    telegram: Mapped[str | None] = mapped_column(String(200), default="https://t.me/rahat_home", nullable=True)
    ...
    youtube: Mapped[str | None] = mapped_column(String(200), default="https://youtube.com/@rahat_home", nullable=True)
