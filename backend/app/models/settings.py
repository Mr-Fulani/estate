...
class SiteSetting(Base):
    ...
    telegram: Mapped[str | None] = mapped_column(String(200), default="", nullable=True)
    whatsapp: Mapped[str | None] = mapped_column(String(200), default="", nullable=True)
    vk: Mapped[str | None] = mapped_column(String(200), default="", nullable=True)
    youtube: Mapped[str | None] = mapped_column(String(200), default="", nullable=True)
