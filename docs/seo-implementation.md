...
В HTTP-проверках после SEO-01 выявлен дополнительный эффект Next.js: streaming может отдавать 200 для notFound при корректном noindex. Требуется дополнительная проверка и исправление SEO-05 на уровне выдачи HTTP-ответа.
